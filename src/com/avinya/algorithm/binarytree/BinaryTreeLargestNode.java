...
public class BinaryTreeLargestNode {
  ...
  public BinaryTreeLargestNode() {
    root = null;
  }

  // largestElement() will find out the largest node in the binary tree
  public int largestElement(final Node temp) {
  ...
  public static void main(final String[] args) {
    final BinaryTreeLargestNode bt = new BinaryTreeLargestNode();
